    ...
    def tokens(line):
        ...
        for ch in line:
            ...
            if is_str_lit:
                ...
                c_word.append(ch)
                if is_delim:
                    if Helper.list_as_str(c_word) in Grammar.DELIMETERS_C:
                        add_token()
            if ch == ' ' and c_word != []:
...
class Reflection:
    ...
    @staticmethod
    def __print_reflection(*args, **kwargs):
    ...
    def reflect(word = 'if'):
        ...
        def reflect_decorator(function):
            ...
            def wrapper(*args, **kwargs):
                ...
                __print_reflection(Name = function.__name__, 
...
class Decorators:
    ...
    stat_object = Reflection.reflect
